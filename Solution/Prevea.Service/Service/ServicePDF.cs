...
namespace Prevea.Service.Service
{
    ...
    public partial class Service
    {
        ...
        private void GetManifiestan(Document pdf, Model.Model.Document document)
        {
            ...
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("I.- Que la Ley 31-995 de 8 de noviembre de PrevenciÃ³n de Riesgos Laborales establece los principios generales relativos a la prevenciÃ³n de los riesgos derivados de las condiciones de trabajo para tratar de establecer un adecuado nivel de protecciÃ³n de la seguridad y salud de los trabajadores", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("II.- De acuerdo con el artÃ­culo 10 del Reglamento de los Servicios de PrevenciÃ³n", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("III.- El Reglamento de los Servicios de PrevenciÃ³n", _STANDARFONT_10);
            pdf.Add(phrase);
            ...
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("Suscribir el correspondiente contrato para la prestaciÃ³n de servicio de prevenciÃ³n", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            ...
            pdf.Add(phrase);
            phrase = new Phrase("c) Facilitar al servicio de prevenciÃ³n PREVEA", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("d) Poner a disposiciÃ³n de PREVEA", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("e) Firmar la recepciÃ³n de informes y recomendaciones emitidos por PREVEA.", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("f) Facilitar cualquier informaciÃ³n no contemplada en los supuestos anteriores y que con criterio tÃ©cnico de las personas que vayan a emitir el asesoramiento y apoyo al empresario", _STANDARFONT_10);
            pdf.Add(phrase);
            ...
            pdf.Add(phrase);
            phrase = new Phrase("l) Comunicar a PREVEA los daÃ±os a la salud derivados del trabajo", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("m) Comunicar a PREVEA de la existencia o apertura de centros de trabajo sometidos a la normativa de Seguridad y Salud en obras de ConstrucciÃ³n.", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            ...
            pdf.Add(phrase);
            phrase = new Phrase("b) En caso de tener que revisar la evaluaciÃ³n de riesgos", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("c) PREVEA realizarÃ¡", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("d) PREVEA realizarÃ¡ la memoria anual de actividades preventivas y la valoraciÃ³n de la efectividad de la integraciÃ³n de la prevenciÃ³n de riesgos laborales en el sistema general de gestiÃ³n de la empresa a travÃ©s de la implantaciÃ³n y aplicaciÃ³n del plan de prevenciÃ³n de riesgos laborales en relaciÃ³n con las actividades preventivas concertadas. Igualmente facilitarÃ¡ la memoria y la programaciÃ³n anual a las que se refiere el apartado artÃ­culo 39.2 de la Ley 31â€¢995.", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("e) PREVEA dedicarÃ¡ anualmente los recursos humanos y materiales necesarios para la realizaciÃ³n de las actividades concertadas.", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("f) PREVEA asesorarÃ¡ al empresario", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("g) PREVEA informarÃ¡ a la EMPRESA CONTRATANTE de las actividades preventivas concretas que sean legalmente exigibles y que no queden cubiertas por el concierto", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("h) Cuando la EMPRESA CONTRATANTE realice actividades o cuente con centros de trabajo sometidos a la normativa de Seguridad y Salud en obras de ConstrucciÃ³n", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("CUARTA: VIGILANCIA DE LA SALUD. A tenor de lo estipulado en la Ley 31-995", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("Por lo expuesto en el pÃ¡rrafo precedente", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("Si se tienen contratados RECONOCIMIENTOS MÃ‰DICOS INDIVIDUALES", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("Cuando los reconocimientos mÃ©dicos concertados", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("Una vez concertadas las fechas para efectuar los reconocimientos mÃ©dicos", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢En caso de no poder acudir a las citas concertadas", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢Si la EMPRESA CONTRATANTE", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢Asimismo y en cualquiera de los dos casos anteriores", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢En el caso de que durante la vigencia del contrato", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("QUINTA: DURACIÃ“N DEL CONTRATO. El presente contrato se pacta", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("El presente contrato se prorrogarÃ¡ automÃ¡ticamente por el mismo plazo determinado en el pÃ¡rrafo anterior una vez llegado la fecha de su vencimiento sin que medie preaviso o renuncia por cualquiera de las dos partes. Dicha renuncia se habrÃ¡ de comunicar fehacientemente con una antelaciÃ³n de dos meses para que la misma sea efectiva.", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("SEXTA: CONDICIONES ECONÃ“MICAS. Se estipula un precio de", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("Ambas partes acuerdan expresamente que la vigencia de este contrato quedarÃ¡ condicionada al pago por parte de la EMPRESA CONTRATANTE de la cantidad acordada. La falta de pago", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("SÃ‰PTIMA: FORMACIÃ“N E INFORMACIÃ“N. En relaciÃ³n al cumplimiento de los artÃ­culos 18 y 19 de la Ley 31-995", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            ...
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("NOVENA: PROTECCIÃ“N DE DATOS. En virtud de lo dispuesto en el artÃ­culo 9 de la Ley OrgÃ¡nica de ProtecciÃ³n de Datos de carÃ¡cter Personal", _STANDARFONT_10);
            pdf.Add(phrase);
            ...
            pdf.Add(phrase);
            phrase = new Phrase("b) Que la EMPRESA CONTRATANTE pone el indicado Fichero a disposiciÃ³n de PREVEA para la prestaciÃ³n del servicio con ella contratado a los efectos del cumplimiento de la Ley 31-995 de 8 de noviembre de PrevenciÃ³n de Riesgos Laborales.", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("c) Que el fichero de los trabajadores puesto a disposiciÃ³n de PREVEA estÃ¡ calificado como de nivel BASICO", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("d) Que de acuerdo con los expositivos precedentes", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("ClÃ¡usula de Confidencialidad y de Encargado de Tratamiento", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("1.- PREVEA", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("2.- La obligaciÃ³n de confidencialidad recogida en el presente contrato tendrÃ¡ carÃ¡cter indefinido", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("3.- PREVEA", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("4.- PREVEA y EMPRESA CONTRATANTE asumen independientemente las responsabilidades que le corresponden a cada una de las partes en el cumplimiento de sus obligaciones de acuerdo con la Ley 15-.999 de ProtecciÃ³n de Datos de CarÃ¡cter Personal. Ambas partes acuerdan dejar indemne a la otra parte por los daÃ±os y perjuicios ocasionados en caso de incumplimiento de sus responsabilidades en relaciÃ³n con lo dispuesto en la Ley OrgÃ¡nica 15â€¢999 y de su Reglamento de Desarrollo el R.D. 1720/2007.", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("5.- PREVEA realizarÃ¡ sus acciones como encargado de tratamiento de acuerdo a las instrucciones que le indique EMPRESA CONTRATANTE", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("6.- A la finalizaciÃ³n de la relaciÃ³n entre las partes", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("7.- La EMPRESA CONTRATANTE", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("DÃ‰CIMA: FUERO. Para resolver cualquier diferencia que pudiera surgir de la aplicaciÃ³n del presente contrato", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("UNDÃ‰CIMA: TRABAJADORES AUTÃ“NOMOS. En el caso de trabajadores autÃ³nomos (sin trabajadores a su cargo)", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            ...
            phrase = new Phrase(" ", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("ANEXO I AL CONTRATO DE PREVENCIÃ“N DE RIESGOS LABORALES ", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            ...
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("En desarrollo a la clÃ¡usula Primera del contrato suscrito por las partes", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            ...
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("NÂº DE CENTROS: ", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("NÃšMERO TRABAJADORES ESPECIALIDADES TÃ‰CNICAS: ", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("NÃšMERO DE TRABAJADORES EN VIGILANCIA DE LA SALUD COLECTIVA: ", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("NÃšMERO DE TRABAJADORES CON RECONOCIMIENTOS MÃ‰DICOS INDIVIDUALES:", _STANDARFONT_10);
            pdf.Add(phrase);
            ...
            pdf.Add(phrase);
            phrase = new Phrase("En caso de centros de trabajo de naturaleza ITINERANTE (centros sin localizaciÃ³n fija)", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("En caso de centros de trabajo sometidos a la normativa de Seguridad y Salud en obras de ConstrucciÃ³n", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            ...
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("2.1. Actividades preventivas incluidas con carÃ¡cter general:", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("2.1.1. ProgramaciÃ³n Anual de la Actividad Preventiva.", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("2.1.2. DiseÃ±o y redacciÃ³n del Plan de PrevenciÃ³n de Riesgos Laborales", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("2.1.3. EvaluaciÃ³n de los factores de riesgo que puedan afectar a la seguridad y salud de los trabajadores en los tÃ©rminos previstos en el artÃ­culo 16 de la Ley 31-995 de PrevenciÃ³n de Riesgos Laborales", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("2.1.4. PlanificaciÃ³n de la Actividad preventiva y determinaciÃ³n de las prioridades en la adopciÃ³n de las medidas preventivas adecuadas.", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("2.1.5. InformaciÃ³n de los Trabajadores de su puesto de trabajo", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("2.1.6. FormaciÃ³n de los Trabajadores de su puesto de trabajo", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("2.1.7. Medidas de Emergencia y primeros auxilios", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("2.1.8. InvestigaciÃ³n de accidentes de trabajo y enfermedades profesionales.", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("2.1.9. ValoraciÃ³n mediante mediciones puntuales de condiciones ambientales de ruido", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("2.1.10. Memoria anual de actividades y valoraciÃ³n de la efectividad de la integraciÃ³n de la prevenciÃ³n de riesgos laborales en el sistema general de gestiÃ³n de la empresa a travÃ©s de la implantaciÃ³n y aplicaciÃ³n del plan de prevenciÃ³n de riesgos laborales en relaciÃ³n con las actividades preventivas concertadas.", _STANDARFONT_10);
            pdf.Add(phrase);
            ...
            pdf.Add(phrase);
            phrase = new Phrase("2.1.13. RevisiÃ³n de la EvaluaciÃ³n de Riesgos en los casos legalmente exigidos", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("Todas estas actuaciones concertados estÃ¡n contratados para cada una de las ESPECIALIDADES TÃ‰CNICAS; Seguridad en el Trabajo", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("a) Las exclusiones establecidas en la clÃ¡usula tercera de este anexo", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("b) La formaciÃ³n serÃ¡ impartida exclusivamente a los trabajadores incluidos en el concierto", _STANDARFONT_10);
            pdf.Add(phrase);
            ...
            pdf.Add(phrase);
            phrase = new Phrase("d) La EMPRESA CONTRATANTE acepta expresamente que es su responsabilidad la integraciÃ³n del Plan de PrevenciÃ³n de Riesgos Laborales", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            ...
            pdf.Add(phrase);
            phrase = new Phrase("PREVEA se compromete a comunicar a la EMPRESA CONTRATANTE la necesidad de realizar otras actividades especÃ­ficas cuando resulte legalmente exigibles", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("2.2.2. Otras actividades especÃ­ficas:", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢Documento de ProtecciÃ³n ATEX (conforme R.D. 681/2003)", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢Planes Amianto (conforme 396/2006)", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢Planes Seguridad en Obras de ConstrucciÃ³n (R.D. 1627-997)", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢CoordinaciÃ³n de Actividades Empresariales", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢Asistencia en calidad de Recurso Preventivo de la EMPRESA CONTRATANTE.", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢RealizaciÃ³n de Planes de AutoprotecciÃ³n (conforme R.D. 393/2007)", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢Documento de Seguridad en el Ã¡mbito de la Industria Extractiva.", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢Visitas de chequeo a obras o instalaciones concretas y emisiÃ³n de sus respectivos informes.", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢RealizaciÃ³n de visitas no programadas de seguimiento", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            ...
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("2.3.2. Otras actividades especÃ­ficas:", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢Mediciones de agentes fÃ­sicos (ruido", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢Mediciones de contaminantes quÃ­micos y realizaciÃ³n de sus respectivos estudios o informes", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢Estudios de exposiciÃ³n a riesgos biolÃ³gicos y realizaciÃ³n de sus respectivos informes", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢RealizaciÃ³n de visitas no programadas de seguimiento", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            ...
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("2.4. Especialidades Preventivas de ErgonomÃ­a y PsicosociologÃ­a Aplicada:", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            ...
            pdf.Add(phrase);
            phrase = new Phrase("PREVEA se compromete a la revisiÃ³n de la EvaluaciÃ³n de Riesgos en los casos legalmente exigidos", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("PREVEA se compromete a comunicar a la EMPRESA CONTRATANTE la necesidad de realizar otras actividades especÃ­ficas cuando resulte legalmente exigibles", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("2.4.2. Otras actividades especÃ­ficas:", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢Estudios especÃ­ficos de ErgonomÃ­a: Estudios de ManipulaciÃ³n Manual de Cargas", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢Estudios Psicosociales.", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢Mediciones de agentes fÃ­sicos ambientales y emisiÃ³n de sus respectivos estudios o informes.", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢RealizaciÃ³n de visitas no programadas de seguimiento", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            ...
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("2.5.1. Vigilancia de la Salud Colectiva. Se realizarÃ¡n las siguientes actividades:", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢AnÃ¡lisis con criterios epidemiolÃ³gicos", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢AnÃ¡lisis de las ausencias que", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢Proporcionar informaciÃ³n a los trabajadores en relaciÃ³n con los efectos para la salud derivados de los riesgos del trabajo y realizar actividades formativas en primeros auxilios.", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢ColaboraciÃ³n con los servicios de atenciÃ³n primaria de salud y de asistencia sanitaria especializada para el diagnÃ³stico", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢Estudio y valoraciÃ³n de los riesgos que puedan afectar a las trabajadoras embarazadas o en situaciÃ³n de parto reciente", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢Resumen de las actividades realizadas durante el concierto en la memoria anual de actividades.", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("2.5.2. Reconocimientos MÃ©dicos Individuales: Se realizarÃ¡n las siguientes actuaciones:", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢RealizaciÃ³n de los exÃ¡menes de salud de los trabajadores", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢Entrega al Empresario de la informaciÃ³n sobre la Aptitud del trabajador para desempeÃ±ar el puesto de trabajo y de las conclusiones de los exÃ¡menes de salud con objeto de mejorar las medidas de prevenciÃ³n y protecciÃ³n de los trabajadores.", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢Entrega del resultado de los exÃ¡menes de salud dirigidos a los trabajadores", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢Las pruebas que se realizarÃ¡n al contratar los reconocimientos mÃ©dicos individuales", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("2.5.3. Otras Pruebas Complementarias:", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢ Pruebas complementarias o parÃ¡metros analÃ­ticos suplementarios que se tengan que realizar en funciÃ³n de lo estipulado en el protocolo mÃ©dico especÃ­fico a aplicar en cada caso", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢Pruebas de radio diagnÃ³stico.", _STANDARFONT_10);
            pdf.Add(phrase);
            ...
            pdf.Add(phrase);
            phrase = new Phrase("â€¢ Certificaciones de instalaciones o maquinarÃ­a", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢ Asesoramiento jurÃ­dico frente a frente a requerimientos", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢ Actividades preventivas que afecten a instalaciones o a trabajadores situadas o que presten servicio fuera del Ã¡mbito territorial de actuaciÃ³n de PREVEA.", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("Otras exclusiones:", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢ No incluirÃ¡", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("4.-CONDICIONES ECONÃ“MICAS:", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("La empresa contratante se compromete a satisfacer a PREVEA.", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢Actividades correspondientes A LAS ESPECIALIDADES TECNICAS DE SEGURIDAD", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("1 Especialidades TÃ©cnicas 10 Trabajadores 45", _STANDARFONT_10);
            pdf.Add(phrase);
            ...
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("1- A los que habrÃ¡ que aÃ±adir el 21% de IVA", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("2- Exentos de IVA ", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("Los reconocimientos mÃ©dicos serÃ¡n abonados:", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("A la realizaciÃ³n A la Firma del Contrato", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("ï€µ ï€µ", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("5. FORMA DE PAGO.", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢ La forma de pago", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢ El pago se realizarÃ¡ por RECIBO BANCO", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("â€¢ NÂº C.C. ", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("    ", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("6. IMPUESTOS.â€¢ Todos los impuestos que graven la prestaciÃ³n de los servicios concertados mediante la suscripciÃ³n del presente contrato serÃ¡n de cuenta de la empresa contratante.", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            ...
            pdf.Add(phrase);
            phrase = new Phrase("AL CONTRATO DE SERVICIO DE PREVENCIÃ“N CON FECHA: 27-0/2016", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("PRIMERO.â€¢ La Entidad __________________________", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("SEGUNDO.â€¢ Desde la firma del presente ANEXO del contrato de Servicio de PrevenciÃ³n", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("SERVICIOS CONCERTADOS", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("SERVICIO DE PREVENCION PREVEA no se responsabiliza de la no subsanaciÃ³n por parte de la entidad o personal responsable de la empresa contratante", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("TERCERO.â€¢ En el supuesto de que durante el desarrollo de las actividades contratados se entendiera por ambas partes la conveniencia de llevar a cabo alguna otra no prevista en este Anexo", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("CUARTO.â€¢ Todos los impuestos que graven la prestaciÃ³n de los servicios concertados mediante la suscripciÃ³n del presente contrato serÃ¡n de cuenta de la empresa contratante.", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            ...
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("CARTA DE GARANTÃA DE PRESTACIÃ“N DE SERVICIOS DE PREVEA", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("PROGRAMACIÃ“N ANUAL PARA LA ACTIVIDAD", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("La Entidad _________________________planifica con la Empresa __________________________ la realizaciÃ³n de la FormaciÃ³n", _STANDARFONT_10);
            pdf.Add(phrase);
            ...
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("FORMACIÃ“N PRESENCIAL DE LOS TRABAJADORES", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("Citas fijadas:", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("Fecha y Hora Trabajadores Lugar y Tipo de Curso", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("FormaciÃ³n en la propia empresa el dÃ­a de la visita tÃ©cnica", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("", _STANDARFONT_10);
            pdf.Add(phrase);
            phrase = new Phrase("VISITAS DEL TÃ‰CNICO DE PREVENCIÃ“N", _STANDARFONT_10);
            pdf.Add(phrase);
